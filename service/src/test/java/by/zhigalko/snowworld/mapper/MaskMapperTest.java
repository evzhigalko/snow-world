...
import by.zhigalko.snowworld.dto.response.MaskResponse;
...
class MaskMapperTest {
    ...
    void maskRequestToMaskTest() {
        ...
        Assertions.assertEquals(maskRequest.getProductName(), mask.getProductName().toString());
    ...
    void maskToMaskResponseTest() {
        ...
        Assertions.assertEquals(mask.getProductName().toString(), maskResponse.getProductName());
        System.out.println(mask);
